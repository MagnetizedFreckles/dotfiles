...
-- Inspired by this awesome guide:
-- https://mwop.net/blog/2024-07-04-how-i-use-wezterm.html

-- Easy way to put plain wezterm configuration and then pass it to wezterm, thanks to:
-- https://github.com/emretuna/.dotfiles/blob/main/wezterm/.config/wezterm/keys.lua
local Keybinds = {}
function Keybinds.setup(config)
    config.key_map_preference = "Physical" -- Helps when using non-latin keyboard layouts

    -- This doesn't work but whatever, it's a template for potential future binds
